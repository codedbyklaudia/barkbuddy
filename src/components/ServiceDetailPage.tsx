...
import { SquarePen, TicketPercent, Star, Info, Search, CheckCircle, AlertCircle } from 'lucide-react';
...
const ServiceDetailPage: React.FC = () => {
  ...
  // ── Auth — read directly from context (same source as Navigation)
  ...
  // ─── Refresh statistics after a new review ─────────────────────────────
  ...
  // ─── Open review modal ──────────────────────────────────────────────────
  // Called from BOTH the sidebar button and the reviews-card button.
  ...
  const handleCloseReview = () => {
    ...
    // Small delay so the fade-out animation completes before resetting
    setTimeout(() => {
      setReviewError('');
      setReviewSuccess(false);
    }, 300);
  ...
  const handleSubmitReview = async (e: React.FormEvent) => {
    ...
    if (!token) {
      // Token disappeared mid-session — boot the user to login
      navigate('/login');
      return;
    }
    ...
    try {
      ...
      if (res.status === 401) {
        // Token expired — let context handle cleanup
        logout();
        navigate('/login');
        return;
      }
      ...
      if (!res.ok) {
        // Show whatever error message the API returned
        setReviewError(data.error || data.message || 'Failed to submit review. Please try again.');
        return;
      }

      // ✅ Success — prepend new review to the list so user sees it immediately
      // Merge in user.name from context in case the API response doesn't include it
      ...
      // Show success state inside modal, then auto-close
      ...
      <section className="activity-details__content">
        ...
        <div className="activity-details__info">
            ...
            <div className="activity-details__photo-hero">
              ...
              >
                ...
                <div className="photo-hero__main-overlay">
                  <span className="photo-hero__zoom-icon">
                    <Search size={46} />
                  </span>
                </div>
              </div>
              ...
              <div className="photo-hero__grid">
                {otherPhotos.slice(0, 4).map((photo, idx) => (
                  ...
                  >
                    ...
                    {idx === 3 && photos.length > 5 && (
                      <div className="photo-hero__more-overlay">
                ...
                {photos.length > 5 && (
                  <div
                    className="photo-hero__more-pill"
              ...
              <div className="detail-item">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="detail-item__value detail-item__value--link"
                  >
          ...
          <div className="activity-details__reviews-card">
            ...
            {/* ── Review button — the only trigger needed here */}
            <button
        ...
        <aside className="activity-details__sidebar">
          <div className="activity-details__cta">
            ...
            {/* ── Sidebar write-review button — same handler */}
            ...
            {reviewSuccess ? (
              ...
              <form onSubmit={handleSubmitReview} className="review-form" noValidate>
                ...
                <div className="review-form__group">
                  ...
                  {reviewRating === 0 && (
                    <span className="review-form__rating-hint">Click a star to rate</span>
                  )}
                </div>
                ...
                <div className="review-form__group">
                  ...
                  <textarea
                    ...
                    onChange={e => {
                      ...
                      if (reviewError) setReviewError(''); // clear error as user types
                    }}
          ...
          <div className="lightbox-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="lightbox__footer">
              {currentPhoto.caption && (
                <p className="lightbox__caption">{currentPhoto.caption}</p>
              )}
