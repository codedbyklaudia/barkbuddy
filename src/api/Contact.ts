        ...
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #f9f8fc; border-radius: 12px;">
          <div style="background: #3b2d6e; border-radius: 10px; padding: 28px 32px; margin-bottom: 28px;">
            <h1 style="font-size: 22px; color: #f9f8fc; margin: 0; font-weight: normal; letter-spacing: 0.03em;">
              New message from BarkBuddy
            </h1>
          </div>

          <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
            <tr>
              <td style="padding: 10px 0; border-bottom: 1px solid #e8e5f0; width: 110px;">
                <span style="font-size: 12px; font-weight: bold; letter-spacing: 0.1em; text-transform: uppercase; color: #8b7fb3;">From</span>
              </td>
              <td style="padding: 10px 0; border-bottom: 1px solid #e8e5f0; font-size: 15px; color: #2d1f5e;">
                ${name}
              </td>
            </tr>
            <tr>
              <td style="padding: 10px 0; border-bottom: 1px solid #e8e5f0;">
                <span style="font-size: 12px; font-weight: bold; letter-spacing: 0.1em; text-transform: uppercase; color: #8b7fb3;">Email</span>
              </td>
              <td style="padding: 10px 0; border-bottom: 1px solid #e8e5f0; font-size: 15px; color: #2d1f5e;">
                <a href="mailto:${email}" style="color: #7c5cbf; text-decoration: none;">${email}</a>
              </td>
            </tr>
            <tr>
              <td style="padding: 10px 0;">
                <span style="font-size: 12px; font-weight: bold; letter-spacing: 0.1em; text-transform: uppercase; color: #8b7fb3;">Subject</span>
              </td>
              <td style="padding: 10px 0; font-size: 15px; color: #2d1f5e;">
